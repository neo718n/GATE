...
interface SeedRow {
  ...
  award: Award;
  notes: string | null;
  // false for rows re-graded after a scoring mistake was found in the
  // original OCR-by-eye pass — correctCount/pointsEarned/award reflect the
  // corrected total, but the per-question `answers` breakdown wasn't
  // individually re-verified against which question(s) changed, so the
  // diagnostic report shows "Coming Soon" instead of misleading detail
  // (see lib/db/schema.ts's eventBadgeResults.performanceReady).
...
const results: SeedRow[] = [
  ...
  { cardNo: "TJK-C-005", subject: "math", category: 3, answers: ["A", "C", "B", "A", "C", "C", "A", "A", "D", "C", "C", "E", "B", "B", "C", "C", "B", "A", "B", "C", "A", "C", "C", "A", "C"], correctCount: 5, totalQuestions: 25, pointsEarned: 20, pointsMax: 100, award: "participation", notes: null, performanceReady: false },
  { cardNo: "UZB-C-013", subject: "math", category: 1, answers: ["A", "D", "D", "B", "C", "B", "B", "D", "D", "A", "C", "A", "B", "D", "C", "C", "D", "C", "C", "C", "C", "D", "C", "B", "A"], correctCount: 21, totalQuestions: 25, pointsEarned: 84, pointsMax: 100, award: "gold", notes: null, performanceReady: false },
  ...
  { cardNo: "TJK-C-007", subject: "math", category: 4, answers: ["", "E", "D", "A", "B", "", "B", "B/C?", "C", "D", "C", "D", "D", "B", "D", "A", "C", "A", "E", "B", "B", "D", "D", "D", "A"], correctCount: 5, totalQuestions: 25, pointsEarned: 20, pointsMax: 100, award: "participation", notes: "Q1: D crossed out, no replacement Q6: C crossed out, no replacement Q8: both B and C checked", performanceReady: false },
  { cardNo: "UZB-C-011", subject: "math", category: 2, answers: ["E", "A", "B", "A", "D", "C", "E", "C", "A", "D", "E", "B", "C", "D", "C", "B", "A", "E", "A", "E", "B", "A", "A", "C", "A"], correctCount: 16, totalQuestions: 25, pointsEarned: 64, pointsMax: 100, award: "participation", notes: null, performanceReady: false },
  ...
  { cardNo: "UZB-C-008", subject: "math", category: 3, answers: ["C", "A", "D", "B", "C", "C", "E", "D", "C", "D", "B", "E", "C", "B", "A", "D", "C", "A", "A", "C", "D", "B", "D", "C", "A"], correctCount: 21, totalQuestions: 25, pointsEarned: 84, pointsMax: 100, award: "silver", notes: null, performanceReady: false },
  ...
  { cardNo: "UZB-C-023", subject: "math", category: 2, answers: ["E", "A", "B", "A", "A", "D", "C", "D", "C", "E", "E", "D", "B", "A", "D", "A", "B", "A", "B", "E", "B", "D", "C", "C", "B"], correctCount: 11, totalQuestions: 25, pointsEarned: 44, pointsMax: 100, award: "participation", notes: "sheet's category row was pre-printed with ALL 5 circles filled black (printing defect); actual choice hand-circled around position 2, consistent with grade 4", performanceReady: false },
  ...
  { cardNo: "UZB-C-007", subject: "math", category: 3, answers: ["D", "A", "D", "B", "E", "C", "E", "D", "C", "D", "B", "E", "B", "A", "A", "D", "A", "A", "A", "C", "D", "B", "E", "C", "C"], correctCount: 15, totalQuestions: 25, pointsEarned: 60, pointsMax: 100, award: "participation", notes: null, performanceReady: false },
  ...
  { cardNo: "UZB-C-022", subject: "math", category: 1, answers: ["A", "B", "C", "B", "C", "B", "B", "D", "D", "A", "C", "C", "B", "D", "B", "B", "C", "D", "A", "C", "C", "D", "B", "B", "C"], correctCount: 13, totalQuestions: 25, pointsEarned: 52, pointsMax: 100, award: "silver", notes: null, performanceReady: false },
  ...
  { cardNo: "TJK-C-004", subject: "english", category: 5, answers: ["C", "B", "B", "B", "A", "C", "B", "A", "D", "D", "D", "A", "C", "D", "D", "B", "B", "B", "D", "B", "C", "D", "D", "A", "A", "B", "B/D?", "", "C", "C", "A", "B", "C", "D", "B", "D", "B", "C", "B", "A"], correctCount: 8, totalQuestions: 40, pointsEarned: 25, pointsMax: 117, award: "participation", notes: "Sheet was already hand-graded by an examiner (score of 25/117 written on it); confirmed correct on re-check (an earlier independent re-score had given 22/117, since revised).", performanceReady: false },
  { cardNo: "TJK-C-001", subject: "english", category: 4, answers: ["C", "C", "B", "B", "B", "B", "A", "B", "A", "D", "B", "A", "B", "B", "D", "C", "D", "B", "A", "C", "A", "B", "B", "B", "B", "D", "B", "A", "B", "A", "A", "C", "B", "B", "B", "B", "B", "B", "C", "D"], correctCount: 24, totalQuestions: 40, pointsEarned: 49, pointsMax: 81, award: "bronze", notes: "Category bubble on the sheet was marked 5 then crossed out; grade (8) matches Category 4, so scored against the Category 4 Entry Diagnostic paper. Max confirmed as 81 (the paper's own summary table), not the 83 its per-question values sum to.", performanceReady: false },
];
...
async function main() {
  ...
  for (const row of results) {
    ...
    await db.insert(eventBadgeResults).values({
      ...
      award: row.award,
      notes: row.notes,
      performanceReady: row.performanceReady ?? true,
    });
