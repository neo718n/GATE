...
const results: SeedRow[] = [
  ...
  { cardNo: "UZB-C-027", subject: "math", category: 1, answers: ["A", "B", "D", "D", "C", "B", "C", "A", "D", "A", "D", "D", "C", "C", "C", "C", "B", "A", "A", "B", "C", "B", "B", "C", "A"], correctCount: 10, totalQuestions: 25, pointsEarned: 40, pointsMax: 100, award: "participation", notes: null },
