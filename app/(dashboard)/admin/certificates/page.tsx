...
export default async function CertificatesPage() {
  ...
  return (
    <div className="flex flex-col gap-8 max-w-5xl">
      ...
      <div className="border border-gate-fog bg-gate-gold/5 border-gate-gold/25 p-5">
      ...
      {publishedResults.length === 0 ? (
        ...
        <div className="flex flex-col gap-0 border border-gate-fog bg-white divide-y divide-gate-fog/40">
          <div className="grid grid-cols-[2fr_1fr_1fr_1fr_100px] gap-4 px-5 py-3 bg-gate-fog/30">
            ...
            >
              ...
              <div>
                {r.certificateUrl ? (
                  ...
                  <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-gate-800/30">
                    Pending
                  </span>
                )}
              </div>
