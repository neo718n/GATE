  ...
  return (
    <div className="flex flex-col gap-8 max-w-5xl">
      <div className="flex flex-col gap-1.5">
        ...
        <h1 className="font-serif text-4xl font-light text-gate-800">Career Applications</h1>
      ...
      {apps.length === 0 ? (
        <div className="border border-gate-fog bg-gate-fog/30 p-8 text-center">
          <p className="text-sm font-light text-gate-800/60">No applications yet.</p>
        </div>
      ) : (
        <div className="flex flex-col gap-4">
          {apps.map((a) => {
            ...
            return (
              <div key={a.id} className="border border-gate-fog bg-white p-6 flex flex-col gap-4">
                <div className="flex items-start justify-between flex-wrap gap-3">
                  <div className="flex flex-col gap-1">
                    <h2 className="text-base font-semibold text-gate-800">{a.fullName}</h2>
                ...
                {a.position && (
                  <p className="text-sm font-light text-gate-800/70">
                ...
                {a.motivationText && (
                  <p className="text-sm font-light text-gate-800/65 leading-[1.9] bg-gate-fog/30 px-4 py-3 line-clamp-3">
