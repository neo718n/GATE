  ...
  return (
    <div className="flex flex-col gap-8 max-w-6xl">
      ...
      <div className="flex flex-col gap-0 border border-gate-fog bg-white divide-y divide-gate-fog/40">
        <div className="grid grid-cols-[2fr_2fr_1.5fr_1.2fr_1fr_1fr_80px] gap-4 px-5 py-3 bg-gate-fog/30">
        ...
        {all.map((p) => (
          <div key={p.id} className="grid grid-cols-[2fr_2fr_1.5fr_1.2fr_1fr_1fr_80px] gap-4 px-5 py-4 items-center">
            ...
            <p className="text-xs font-light text-gate-800/70 truncate">{p.round?.name ?? "—"}</p>
