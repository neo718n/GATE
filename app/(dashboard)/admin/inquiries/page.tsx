  ...
  return (
    <div className="flex flex-col gap-8 max-w-3xl">
      <div className="flex flex-col gap-1.5">
        ...
        <h1 className="font-serif text-4xl font-light text-gate-800">Academic Inquiries</h1>
      ...
      <div className="border border-gate-fog bg-gate-fog/30 p-8 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2 pt-2">
          {[
            ...
            <div key={pt} className="flex items-start gap-3 text-sm font-light text-gate-800/60">
