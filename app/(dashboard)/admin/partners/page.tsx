  ...
  return (
    <div className="flex flex-col gap-8 max-w-5xl">
      <div className="flex flex-col gap-1.5">
        ...
        <h1 className="font-serif text-4xl font-light text-foreground">Partner Applications</h1>
      ...
      {allPartners.length === 0 ? (
        <div className="border border-border bg-muted/30 p-8 text-center">
          <p className="text-sm font-light text-foreground/60">No partner applications yet.</p>
        </div>
      ) : (
        <div className="flex flex-col gap-4">
          {allPartners.map((p) => (
            <div key={p.id} className="border border-border bg-card p-6 flex flex-col gap-4">
              <div className="flex items-start justify-between flex-wrap gap-3">
                <div className="flex flex-col gap-1">
                  <h2 className="text-base font-semibold text-foreground">{p.organizationName}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm font-light text-foreground/65">
                <div>
                  <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-foreground/50 block mb-1">
                    Contact
                  </span>
              ...
              {p.message && (
                <p className="text-sm font-light text-foreground/65 leading-[1.9] bg-muted/30 px-4 py-3">
