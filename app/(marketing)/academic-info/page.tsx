...
export const metadata: Metadata = {
  ...
  description: "G.A.T.E. Olympiad eligibility, registration, exam format, rules, and frequently asked questions.",
};
...
const FAQS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What format does Round II take?", a: "Round II is conducted in-person at Xidian University, Hangzhou. It uses university examination conditions — supervised, timed, written. The format is comparable to international olympiad standards." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How are Round II participants selected?", a: "Participants who achieve a score at or above the qualifying threshold in Round I receive an official invitation to the Global Onsite Olympiad. The threshold is determined per cycle." },
