          ...
          <div className="lg:col-span-2 flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-4 text-sm font-light text-gate-800/60 leading-[1.9]">
                <p>G.A.T.E. — the Global Academic and Theoretical Excellence Assessment — was founded to create a credible, transparent, and academically rigorous platform for international competition across five core disciplines.</p>
