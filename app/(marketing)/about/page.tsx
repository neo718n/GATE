    ...
    <>
      <section className="py-24 px-6 border-b border-border/30 bg-gate-800/10">
        <div className="mx-auto max-w-7xl flex flex-col gap-4">
          ...
          <h1 className="font-serif text-5xl md:text-6xl font-light text-gate-white leading-tight">A Global Standard for<br />Academic Excellence</h1>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 flex flex-col gap-10">
            <div className="flex flex-col gap-5">
              <h2 className="text-[11px] font-bold uppercase tracking-[0.4em] text-gate-white/70">Vision</h2>
              <p className="font-serif text-2xl font-light text-gate-white/90 leading-relaxed">A world in which academic talent is recognized and nurtured without regard for geography — where the most rigorous minds meet on equal terms.</p>
            </div>
            <div className="h-px bg-border/30" />
            <div className="flex flex-col gap-5">
              <h2 className="text-[11px] font-bold uppercase tracking-[0.4em] text-gate-white/70">Mission</h2>
          ...
          <div className="flex flex-col gap-6">
            {[
              ...
              <div key={item.label} className="flex flex-col gap-1 border-b border-border/25 pb-5 last:border-0">
                <span className="text-[9px] font-bold uppercase tracking-[0.3em] text-gate-gold/60">{item.label}</span>
                <span className="text-sm font-light text-gate-white/70 whitespace-pre-line">{item.value}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-gate-800/15 border-y border-border/30">
        <div className="mx-auto max-w-7xl flex flex-col gap-12">
          <div className="flex flex-col gap-4">
            ...
            <h2 className="font-serif text-4xl font-light text-gate-white max-w-2xl">Designed for the Highest Level of Academic Rigor</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title} className="flex flex-col gap-4 border border-border/40 p-8">
                <h3 className="text-[11px] font-bold uppercase tracking-[0.3em] text-gate-white">{item.title}</h3>
      ...
      <section className="py-24 px-6">
        <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="flex flex-col gap-6">
            ...
            <h2 className="font-serif text-4xl font-light text-gate-white leading-tight">Open to Students Everywhere</h2>
            <div className="flex flex-col gap-4 text-sm font-light text-gate-white/60 leading-[1.9]">
